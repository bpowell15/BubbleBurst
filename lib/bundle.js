    ...
    value: function bubbleCollision(bubble) {
      ...
      for (var r = 0; r < this.board.bubbles.length; r++) {
        ...
        for (var c = 0; c < this.board.bubbles[r].length; c++) {
          ...
          if ((this.board.bubbles[r][c].x - bubble.x > -10 && this.board.bubbles[r][c].x - bubble.x < 0 || this.board.bubbles[r][c].x - bubble.x < 10 && this.board.bubbles[r][c].x - bubble.x > 0) && (this.board.bubbles[r][c].y - bubble.y > -10 && this.board.bubbles[r][c].y - bubble.y < 0 || this.board.bubbles[r][c].y - bubble.y < 10 && this.board.bubbles[r][c].y - bubble.y > 0)) {
