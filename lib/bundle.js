...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function removeCollidedShots() {
      var _this2 = this;

      debugger;
      this.finishedShots.forEach(function (idx) {
        if (_this2.board.shotBubbles[idx].y === 10) {
          _this2.board.bubbles[0].push(_this2.board.shotBubbles[idx]);
        }
