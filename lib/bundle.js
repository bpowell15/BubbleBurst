    ...
    value: function loadBubbles() {
      if (this.loadedBubbles.length !== 2) {
        if (this.loadedBubbles.length === 0) {
          ...
          this.loadedBubbles.push(new _bubble2.default(this.canvas.width / 3 + 50, this.canvas.height - 15, this.ctx, 1));
        }
        this.loadBubbles();
      }
    }
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function drawGame() {
      ...
      // this.ctx.fillText(`HighScore: ${this.highscore}`, 25,this.canvas.height-5);
    ...
    value: function findNeighbors(bubble) {
      ...
      neighbors.forEach(function (neighbor) {
        if (_this2.shotBubble === null && neighbor !== undefined && neighbor.type === 1) {
          neighborMatch.push(neighbor);
        } else if (neighbor !== undefined && neighbor.type === 1 && neighbor.bubbleColor === _this2.shotBubble.bubbleColor) {
          neighborMatch.push(neighbor);
        }
      });
    ...
    value: function findFloaters() {
      ...
      var _loop = function _loop(_c) {
        ...
        while (queue.length > 0) {
          ...
          var neighbors = _this3.findNeighbors(bubb);
          neighbors.forEach(function (neighbor) {
    ...
    key: 'removeFloats',
    value: function removeFloats() {

      this.floats.forEach(function (bubble) {
        bubble.type = 0;
      });
    }
  }, {
    key: 'animateFloats',
    value: function animateFloats() {
      this.floats.shift();
      this.floats.forEach(function (bubble) {
        bubble.y += 20;
      });
    ...
    value: function loadNextRow() {
      ...
      if (this.nextRow.length !== BOARDOPTIONS.columnCount) {
        for (var c = 0; c < BOARDOPTIONS.columnCount; c++) {
          ...
          this.nextRow.push(new _bubble3.default(bubbleX, 15, this.ctx, 1, { r: 0, c: c }));
        }
      }
    }
  }, {
