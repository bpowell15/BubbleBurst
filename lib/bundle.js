  ...
  _createClass(Game, [{
    ...
    value: function findNeighbors(bubble) {
      ...
      neighbors.forEach(function (neighbor) {
        if (neighbor !== undefined && neighbor.type === 1 && neighbor.bubbleColor === _this.shotBubble.bubbleColor) {
    ...
    value: function removeCluster(cluster) {
      ...
      var audio = new Audio('/Users/bricepowell/desktop/JavaScriptProject/BubbleBurst/assets/Pop-sound-effect.mp3');
      audio.play();
      setTimeout(pop, 100);
    }
  }, {
